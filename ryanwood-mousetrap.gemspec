...
Gem::Specification.new do |s|
  s.name = %q{ryanwood-mousetrap}
  s.version = "0.5.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jon Larkowski", "Sandro Turriate", "Wolfram Arnold", "Corey Grusden", "Cameron Cox", "Ryan Wood"]
  s.date = %q{2010-05-20}
  ...
  s.homepage = %q{http://github.com/ryanwood/mousetrap}
